...
@pytest.mark.anyio
@pytest.mark.unit
async def test_upload_image_client_error(image_obj, mock_image_db_repo, mock_image_s3_repo, image_service, mock_file):
  mock_image_db_repo.save.return_value = image_obj
  mock_image_s3_repo.upload_to_s3.side_effect = ClientError({"Error": {"Code": "TestS3Error", "Message": "S3 upload failed"}}, "PutObject")
  mock_image_db_repo.delete.return_value = None
...
@pytest.mark.anyio
@pytest.mark.unit
async def test_upload_image_botocore_error(image_obj, mock_image_db_repo, mock_image_s3_repo, image_service, mock_file):
  mock_image_db_repo.save.return_value = image_obj
